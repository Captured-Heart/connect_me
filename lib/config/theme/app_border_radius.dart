...
class AppBorderRadius {
  ...
  static const BorderRadius c24 = BorderRadius.all(Radius.circular(24));
...
class AppEdgeInsets {
  AppEdgeInsets._();
  static const EdgeInsets eA05 = EdgeInsets.all(0.5);
  static const EdgeInsets eA1 = EdgeInsets.all(1);
  ...
  static const EdgeInsets eV25 = EdgeInsets.symmetric(vertical: 25);
  static const EdgeInsets eV30 = EdgeInsets.symmetric(vertical: 30);
  static const EdgeInsets eV45 = EdgeInsets.symmetric(vertical: 45);
  static const EdgeInsets eV50 = EdgeInsets.symmetric(vertical: 50);
}
