...
final fetchWorkListProvider =
  ...
  String userUuid = ref.watch(authStateChangesProvider).value!.uid;
//
  final fetchProfileRepoImpl = ref.read(fetchProfileRepoImplProvider);
  return await fetchProfileRepoImpl.fetchWorkList(uuid: uuid?.isEmpty == true|| uuid == null  ? userUuid : uuid);
});
...
//
  final fetchProfileRepoImpl = ref.read(fetchProfileRepoImplProvider);
  return await fetchProfileRepoImpl.fetchEducationList(uuid: uuid?.isEmpty == true|| uuid == null  ? userUuid : uuid);
});
